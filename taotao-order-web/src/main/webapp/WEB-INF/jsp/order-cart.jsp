...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="索菲亚"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="158****6464"/>
		<input type="hidden" name="orderShipping.receiverState" value="江苏"/>
		<input type="hidden" name="orderShipping.receiverCity" value="南京"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="鼓楼区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="中央门 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">索菲亚</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">151****6464</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">江苏 南京市 鼓楼区 中央门建设银行</div>
						<div class="adr-m" limit="30">南京中央门 xxxxxxxxx</div>
