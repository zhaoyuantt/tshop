 ...
 * Generated at: 2019-11-27 09:52:36 UTC
...
public final class item_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("\t <ul id=\"itemCategory\" class=\"easyui-tree\">\r\n");
      out.write("    </ul>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"itemCategoryMenu\" class=\"easyui-menu\" style=\"width:120px;\" data-options=\"onClick:menuHandler\">\r\n");
      ...
      out.write("            $('#itemCategoryMenu').menu('show',{\r\n");
      ...
      out.write("        \t\t});\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\t//ADD BY ZHAOYUNA ON 2019-05-08\r\n");
      out.write("        \t\t$.post(\r\n");
      out.write("        \t\t\t\t\"/item/cat/update\",\r\n");
      out.write("        \t\t\t\t{id:node.id,name:node.text},\r\n");
      out.write("        \t\t\t\tfunction(data){\r\n");
      out.write("        \t\t\t\t\tif(200 != data.status){\r\n");
      out.write("        \t\t\t\t\t\t$.messager.alert('提示','重命名'+node.text+' 分类失败!'+data.msg);\r\n");
      out.write("        \t\t\t\t\t}\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t);\r\n");
      out.write("        \t\t//END ADD\r\n");
      ...
      out.write("\tvar tree = $(\"#itemCategory\");\r\n");
      ...
      out.write("\t\t$.messager.confirm('确认','确定删除名为 '+node.text+' 的分类吗？同时将删除该分类下的所有分类',function(r){\r\n");
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.post(\r\n");
      out.write("\t\t\t\t\"/item/cat/delete\",\r\n");
      out.write("\t\t\t\t{parentId:node.parentId,id:node.id},\r\n");
      out.write("\t\t\t\tfunction(data){\r\n");
      out.write("\t\t\t\t\tif(200 == data.status){\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('提示','分类 '+node.text+ ' 删除成功');\r\n");
      out.write("\t\t\t\t\t\ttree.tree(\"remove\",node.target);\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('提示','分类 '+node.text+ '删除失败!'+data.msg);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
