...
<table class="easyui-datagrid" id="itemPropertyList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/item/param/list',method:'get',pageSize:30,toolbar:itemPropertyListToolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'paramData',width:350,formatter:formatItemParamData">规格(只显示分组名称)</th>
